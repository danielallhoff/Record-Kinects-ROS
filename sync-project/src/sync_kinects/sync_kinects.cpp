...
void test(const ImageConstPtr& kinect1){
...
int main(int argc, char **argv){
    ...
    message_filters::Subscriber<Image> * kinect1 = new message_filters::Subscriber<Image>(n, "/camera/rgb/image_raw",1);
    message_filters::Subscriber<Image> * kinect2 = new message_filters::Subscriber<Image>(n, "/kinect1/rgb/image_raw",1);
    message_filters::Subscriber<Image> * kinect3 = new message_filters::Subscriber<Image>(n, "/kinect2/rgb/image_raw",1);

    //ros::Subscriber sub = n.subscribe("/camera/rgb/image_raw",1, test);
